...
/**
 * AdminCtaHands
 * CTA cuối trang chủ — tiêu đề lớn giữa, 2 bàn tay outline trang trí 2 bên,
 * 2 pill thông tin liên hệ (email/hotline) và 1 nút "Đăng ký hội viên" lớn.
 *
 * Props:
 *  - background : { type, color, gradientFrom, gradientTo, gradientDirection, imageUrl }
 *  - titleLines : string[] — mỗi dòng tiêu đề (cho phép xuống dòng tuỳ ý)
 *  - email      : string
 *  - hotline    : string
 *  - buttonText : string
 *  - buttonUrl  : string
 *  - showHands  : boolean — hiện hoạ tiết 2 bàn tay
 */
const AdminCtaHands = ({
  background = {},
  titleLines = [
