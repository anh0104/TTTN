...
const AdminHeroSenHong = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="admin-hero-senhong-card"
          style={{
            background: `rgba(255,255,255,${cardOpacity})`,
            backdropFilter: 'blur(20px)',
            WebkitBackdropFilter: 'blur(20px)',
            /* Bo góc dạng "lá": 2 góc bên trái vuông, 2 góc bên phải tròn lớn — đúng ảnh thiết kế */
            borderRadius: `0 ${cardBorderRadius * 3}px ${cardBorderRadius * 3}px 0`,
            padding: '44px 48px',
            maxWidth: 500,
        ...
        >
          ...
          {/* Title */}
          <h1
            className="admin-hero-senhong-title"
            style={{
              fontSize: titleSize,
              fontWeight: 900,
              color: titleColor,
      ...
      {/* ── Responsive ──
          - Tablet (≤768px): giảm padding section, card hẹp hơn, font tiêu đề nhỏ lại
          - Mobile (≤480px): card full-width, padding nhỏ hơn nữa, ép cardPosition về center
      */}
      <style>{`
        @media (max-width: 768px) {
          ...
          .admin-hero-senhong-card {
            max-width: 100% !important;
            padding: 32px 28px !important;
          }
          .admin-hero-senhong-title {
            font-size: clamp(36px, 9vw, ${titleSize}px) !important;
          }
        }
