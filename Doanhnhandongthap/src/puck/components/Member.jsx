...
export default function Member({
  ...
  return (
    <div>
      {/* Page title */}
      <section style={{ padding: '64px 0 40px', background: '#fff', textAlign: 'center', borderBottom: '3px solid #E8A020', display: 'inline-block', width: '100%' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 32px' }}>
          <h1 style={{ color: '#0A2472', fontSize: 'clamp(28px,4vw,48px)', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 12 }}>{pageTitle}</h1>
