...
// node_modules/@puckeditor/core/dist/chunk-SHVCBQDY.mjs
...
// node_modules/@puckeditor/core/dist/chunk-DVZWVU66.mjs
init_react_import();
init_react_import();
  ...
  if (buf) {
    ...
    if (offset4 < 0 || offset4 + 16 > buf.length) {
      throw new RangeError(
        `UUID byte range ${offset4}:${offset4 + 15} is out of buffer bounds`
      );
    }
    for (let i = 0; i < 16; ++i) {
...
// node_modules/@puckeditor/core/dist/chunk-6MO3E35Y.mjs
init_react_import();
...
// node_modules/@puckeditor/core/dist/chunk-XQHCQEAF.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-popper/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.mjs
...
var ActionBar = ({
  ...
  "div",
  {
    ...
    children: [
      label && (0, import_jsx_runtime9.jsx)(ActionBar.Group, { children: (0, import_jsx_runtime9.jsx)("div", { className: getClassName("label"), children: label }) }),
      children
    ]
  }
);
var Action = (0, import_react6.forwardRef)((_a, ref) => {
...
var Group = ({ children }) => (0, import_jsx_runtime9.jsx)("div", { className: getClassName("group"), children });
var Label = ({ label }) => (0, import_jsx_runtime9.jsx)("div", { className: getClassName("label"), children: label });
var Separator = () => (0, import_jsx_runtime9.jsx)("div", { className: getClassName("separator") });
...
var createLucideIcon = (iconName, iconNode) => {
  const Component = (0, import_react7.forwardRef)(
    (_a, ref) => {
      ...
      return (0, import_react7.createElement)(Icon, __spreadValues({
        ref,
        iconNode,
...
var useMonitorHotkeys = () => {
  (0, import_react11.useEffect)(() => monitorHotkeys(document), []);
};
...
var useRegisterFieldsSlice = (appStore, id) => {
  const resolveFields = (0, import_react13.useCallback)(
  ...
  (_a, ref) => {
    ...
    return (0, import_jsx_runtime11.jsxs)(
      ...
      __spreadProps(__spreadValues({}, rest), {
        ...
        children: [
          children,
          loading && (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
            "  ",
            (0, import_jsx_runtime11.jsx)(Loader, { size: 14 })
          ] })
        ]
      })
    );
...
init_react_import();
var ControlContext = (0, import_react15.createContext)({});
var useControlContext = () => {
  return (0, import_react15.useContext)(ControlContext);
};
init_react_import();
init_react_import();
init_react_import();
...
var Item = ({
  ...
  return (0, import_jsx_runtime12.jsx)("button", { className: getItemClassName({ isSelected }), onClick, children });
};
var Select = ({
  children,
  options,
  ...
  const buttonInner = (0, import_jsx_runtime12.jsxs)("div", { className: getClassName4("buttonInner"), children: [
    (0, import_jsx_runtime12.jsx)("span", { className: getClassName4("buttonIcon"), children }),
    (0, import_jsx_runtime12.jsx)(ChevronDown, { size: 12 })
  ] });
  const trigger = mode === "actionBar" ? (0, import_jsx_runtime12.jsx)(Action, { active: value !== defaultValue, disabled: isDisabled, children: buttonInner }) : (0, import_jsx_runtime12.jsx)(
    IconButton,
    {
      title: "Select",
  ...
  return (0, import_jsx_runtime12.jsx)(
    "div",
    {
      ...
      children: (0, import_jsx_runtime12.jsxs)(Popover, { open, onOpenChange: setOpen, children: [
        hasOptions ? (0, import_jsx_runtime12.jsx)(PopoverTrigger, { asChild: true, children: trigger }) : trigger,
        options.length > 0 && (0, import_jsx_runtime12.jsx)(PopoverPortal, { children: (0, import_jsx_runtime12.jsx)(PopoverContent, { align: "start", children: (0, import_jsx_runtime12.jsx)("ul", { className: getClassName4("items"), "data-puck-rte-menu": true, children: options.map((option) => {
          const Icon2 = option.icon;
          return (0, import_jsx_runtime12.jsx)("li", { children: (0, import_jsx_runtime12.jsxs)(
            Item,
            {
              ...
              children: [
                Icon2 && (0, import_jsx_runtime12.jsx)("div", { className: getItemClassName("icon"), children: (0, import_jsx_runtime12.jsx)(Icon2, { size: 16 }) }),
                option.label
              ]
            }
          ) }, option.value);
...
function SelectControl({
  ...
  const optionsByValue = (0, import_react16.useMemo)(
    () => options.reduce(
  ...
  return (0, import_jsx_runtime13.jsx)(
    Select,
    {
      ...
      disabled: readOnly,
      children: (0, import_jsx_runtime13.jsx)(Node2, {})
    }
  );
}
...
@puckeditor/core/dist/chunk-XQHCQEAF.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=chunk-I74Z6EL2.js.map
