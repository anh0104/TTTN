...
export default function AboutUs({
  ...
  const safeVideoUrl = videoUrl || 'https://www.youtube.com/embed/dQw4w9WgXcQ'
  return (
          ...
          <div style={{ borderRadius: 12, overflow: 'hidden', background: '#111', aspectRatio: '16/9', position: 'relative', cursor: 'pointer' }}
            ...
            {!playing ? (
              <>
                ...
                <div style={{ position:'absolute',inset:0,display:'flex',alignItems:'center',justifyContent:'center',background: videoThumb ? 'rgba(0,0,0,0.2)' : 'rgba(0,0,0,0.6)' }}>
              ...
              <iframe src={safeVideoUrl+'?autoplay=1'} style={{ width:'100%',height:'100%',border:'none' }} allow="autoplay;fullscreen" title="video" />
            )}
          </div>
        </div>
      </div>
