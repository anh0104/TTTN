    ...
    <footer>
      <div style={{ background: '#F5C518', padding: '56px 0 40px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64 }}>
          <div>
            <div style={{ marginBottom: 20 }}>
              <svg width="140" height="64" viewBox="0 0 140 64">
                <text x="6" y="50" fontFamily="Arial Black,Arial" fontWeight="900" fontSize="44"
                  fill="#F5A800" stroke="#E07800" strokeWidth="3" strokeLinejoin="round">metik</text>
          ...
          <div>
            <h3 style={{ color: '#2E7D32', fontSize: 18, fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 20 }}>{contactTitle || 'THÔNG TIN LIÊN HỆ'}</h3>
