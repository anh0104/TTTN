        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48 }}>
          {safeReviews.map((r, i) => (
            <div key={i} style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
              <img src={r.avatar||'https://i.pravatar.cc/80?img=1'} alt={r.name||''} style={{ width:72,height:72,borderRadius:'50%',objectFit:'cover',flexShrink:0,border:'3px solid #FFD700' }} onError={e=>e.target.src='https://i.pravatar.cc/80?img=1'} />
              <div>
