...
/**
 * AdminNewsFeatured
 * Tin tức & Sự kiện — layout 2 cột lớn, mỗi bài có ảnh to + badge "Mới nhất"
 * màu vàng góc phải trên. Có link "Xem thêm →" ở header.
 *
 * Props:
 ...
 *  - viewMoreText  : string
 *  - viewMoreUrl   : string
 *  - articles      : [{ image, date, title, excerpt, url, badge }]
 */
